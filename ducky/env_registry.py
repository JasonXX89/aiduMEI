...
KNOWN_ENV_VARS: frozenset[str] = frozenset((
    ...
    "AIDUMEI_EPISTEMIC_MULT_REASONED",
    ...
    "AIDUMEI_CREDIT_WEIGHT",
    "AIDUMEI_ROLLUP_ENABLED",
    "AIDUMEI_EPISODE_GAMMA",
    "AIDUMEI_EPISODE_LAMBDA",
    "AIDUMEI_EPISODE_DELTA",
    "AIDUMEI_EPISODE_HALF_LIFE_DAYS",
    "AIDUMEI_EPISODE_MIN_TRACE_VALUE",
    "AIDUMEI_FACTS_WATERMARK",
    "AIDUMEI_FEDERATION_ADMINS",
    ...
    "AIDUMEI_LLM_API_KEY",
    "AIDUMEI_EMBEDDER_API_KEY",
    "AIDUMEI_RERANKER_API_KEY",
    ...
    # v20.4.0 P1：限流兜底全局桶（未配 user_id 时按全局桶挡 user_id 轮换）
    "AIDUMEI_RATE_ADD_GLOBAL_PER_MIN",
    "AIDUMEI_RATE_DELETE_ALL_GLOBAL_PER_MIN",
...
# FROZEN_LEGACY_AIDUMEM 是旧前缀的**冻结快照**：新增旧前缀变量、快照里的名字
# 从真相源消失，tests/test_v20_4_env_prefix.py 都红。
FROZEN_LEGACY_AIDUMEM: frozenset[str] = frozenset((
    "AIDUMEM_ALLOW_INSECURE_PUBLIC",
    "AIDUMEM_API_BASE",
    "AIDUMEM_API_PORT",
    "AIDUMEM_API_TOKEN",
